         ...
         <div id="d_member">
            ...
            <div style="margin: 10px 0;">
               ...
               <a id="btn" href="javascript:memberInsert()"
                  class="easyui-linkbutton" data-options="iconCls:'icon-add'">입력</a>
               <a id="btn" href="javascript:memberUpdate()"
                  class="easyui-linkbutton" data-options="iconCls:'icon-edit'">수정</a>
...
=====================================================================================
 -->
         <div id="d_receiveMemoList">
            ...
            Home > 쪽지관리 > 받은쪽지함
            <hr>
            <table id="d_receiveMemoList" class="easyui-datagrid"
               style="width: 700px; height: 250px"
               data-options="singleSelect:true,collapsible:true, method:'get'">
               <thead>
                  <tr>
                     ...
                     <th data-options="field:'MEM_NAME',width:300, align:'left'">보낸사람
                        이름</th>
                     <th data-options="field:'READ_YN',width:80,align:'center'">개봉여부</th>
                     <th data-options="field:'BUTTON',width:80,align:'center'">버튼</th>
                  </tr>
               </thead>
            </table>
            <div id="dlg_memoContent" footer="dlg_memoContent" class="easyui-dialog"
               title="쪽지쓰기" data-options="modal:true,closed:true"
               style="width: 600px; height: 200px; padding: 10px">
               <div id="dlg_memoContent" align="right">
                  <a href="javascript:memoContentClose()" class="easyui-linkbutton"
 ...
 -->
            ...
            <div id="dlg_memo" footer="#btn_zipcode" class="easyui-dialog"
               ...
               <div id="btn_memo" align="right">
                  <a href="javascript:memoFormClose()" class="easyui-linkbutton"
                     iconCls="icon-clear">닫기</a>
               </div>
