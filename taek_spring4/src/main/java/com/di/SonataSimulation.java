...
public class SonataSimulation {
	...
	public static void main(String[] args) throws Exception {
		...
		// 스프링으로부터 빈(bean:클래스임)을 관리받지 않는 코드임
		// 스프링으로부 객체의 라이프사이클을 관리 받으려면 xml문서에 등록하거나 최근에는 어노테이션을 지원하고 있습니다. spring boot
		// 어노테이션은 자바 코드에 작성하고
